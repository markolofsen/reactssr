...
import ProtectedComponent from '../../../containers/NotFoundPage'
...
import { userIsAuthenticatedRedir, userIsNotAuthenticatedRedir, userIsAdminRedir,
 ...
 const LoginLink = userIsNotAuthenticated(() => {
     return (
         <NavLink to="/p/login" className={theme.buttonLogin}><Button color="inherit" data-link-button="white">Auth</Button></NavLink>
     )
 })
